...
//       test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement SubjectShipmentsCluster = driver.findElement(By.id("subject-Shipments"));
        SubjectShipmentsCluster.click();
        Thread.sleep(5 * 1000);
        test.createNode("International Cluster Click to Show  Working of Internal View");
        WebElement InternationalCluster = driver.findElement(By.id("table-International"));
...
//      test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement FreightChargesCluster = driver.findElement(By.id("table-Freight Charges"));
...
//        test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement DocumentsCluster = driver.findElement(By.id("table-Documents"));
    ...
    public void DataStudioDocumentsURLsClusterForeignAndPrimaryKey() throws Exception {
        ...
        WebElement DocumentsURLsCluster = driver.findElement(By.id("table-Document URLs"));
...
//        test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement PackingItemsCluster = driver.findElement(By.id("table-Packing Items"));
...
//        test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement PackagesCluster = driver.findElement(By.id("table-Packages"));
...
//        test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement LocationCluster = driver.findElement(By.id("table-Location"));
...
//       test.createNode("Refreshing :\"A4data Screen\"");
        ...
        WebElement ShipmentsCluster = driver.findElement(By.id("table-Shipments"));
